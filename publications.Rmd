...
cat(article_html <- generate_article_html(
  title = "How similar are species names and why does this matter for biodiversity data",
  authors = c("A. Menegotto","C. Ronquillo","J. Hortal","T.J. Webb"),
  journal = "ARPHA Preprints",
  year = 2026,
  doi = "https://doi.org/10.3897/arphapreprints.e196971",
  repository_link = "https://github.com/AndreMenegotto/SciNames-similarity"
))
```
-->
...
cat(article_html <- generate_article_html(
  ...
  pages = "e196932",
  year = 2026,
  doi = "https://doi.org/10.3897/BDJ.14.e196932",
  repository_link = "https://doi.org/10.5281/zenodo.20796132"
))


cat(article_html <- generate_article_html(
  title = "Patterns and Drivers of Knowledge Gaps in Global Databases of Mammal Traits",
  authors = c("S. Llorente-Culebras","R. Correia","A. Menegotto","A.M.C. Santos","R.J. Ladle"),
  journal = "Diversity and Distributions",
  volume = 32,
  pages = "e70184",
  year = 2026,
  doi = "https://doi.org/10.1111/ddi.70184",
  repository_link = "https://doi.org/10.5061/dryad.05qfttfdq"
))
